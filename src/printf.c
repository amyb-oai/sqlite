    ...
    switch( xtype ){
      ...
      case etGENERIC: {
        ...
        */
        ...
        /* Reserve one extra byte for %!e cases that keep a trailing "0"
        ** after "." and can render a 3-digit exponent (for example
        ** "-1.0e+100"). */
        szBufNeeded = MAX(e2,0)+(i64)precision+(i64)width+9;
